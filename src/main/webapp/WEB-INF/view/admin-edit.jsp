...
<%@ include file="navbaradmin.jsp"%>
	...
	<h1 class="d-flex justify-content-center mb-5">Edit data</h1>
	...
	<div
		...
		<%-- <c:forEach var="user" items="${listuser}"> --%>
			...
			<div class="mb-3">
				<label class="form-label" for="inputfname">Phone Number</label>
...
<%-- 			<div class="mb-3">
			...
			<button type="submit" class="btn btn-primary" id="edit"
				name="edit" style="width:420px">Change data</button>
		<%-- </c:forEach> --%>
		</form>
